...
const getRecipeByName = (data, diet, intolerances) => {
    const url = "https://webknox-recipes.p.rapidapi.com/recipes/search?diet=" + diet + "&intolerances=" + intolerances + "&query=" + data.recipeName
    const config = {
        method: "GET", 
        headers
    }
